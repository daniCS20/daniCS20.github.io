...
*
* Purpose:The purpose of this class is to manage a series 
* of method that involve house information that I can access and manipulate in 
* the main method. This holds house information, whether it is for sale or not, etc. 
*
...
public class House {
	...
	public boolean equals(House h) {
		boolean ifColorSame;
		// Your code here
		//.equals because it compares enum values 
		...
		//house 2
		double price2=h.getPrice();
		double width2=this.getWidth();
		double length2=this.getLength();
		double height2=this.getHeight();
		
		if (price1==price2 && width1==width2 && length1==length2 && height1==height2 && ifColorSame==true) {
			return true;
		}
